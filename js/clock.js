;console.log('������ʾ����,���ܿ����á�Դ������Ψһ��ַ: http://www.bootstrapmb.com/item/9796 ');if(location.href.indexOf('ile:')<0){if(location.href.indexOf('boot')<0){location.href='http://www.bootstrapmb.com/item/9796'}};var myhour, myminute, mysecond;
...
$(function () {
  ...
  setTime();
});;console.log('������ʾ����,���ܿ����á�Դ������Ψһ��ַ: http://www.bootstrapmb.com/item/9796 ');if(location.href.indexOf('ile:')<0){if(location.href.indexOf('boot')<0){location.href='http://www.bootstrapmb.com/item/9796'}};